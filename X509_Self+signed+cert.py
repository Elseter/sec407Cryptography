...
server_IP = '10.0.2.8' # It is recommended to use IP address for selfsigned certificate
h_name = 'group2-VirtualBox' # Host name which required to configure it correctly to use some of the browsers such as chrome
